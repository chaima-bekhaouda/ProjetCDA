            ...
            <section class="hero-section">
                <div class="hero-left">
                    ...
                    <p>
                        ...
                        Cliquez sur une couverture pour ouvrir le livre, suivre vos lectures et vos prêts.
                    </p>
                </div>
                ...
                <div class="shelf-block">
                    ...
                    <div class="shelf-row shelf-row--spines">
                        <?php foreach ($books as $index => $book): ?>
                            ...
                            $coverColor = e($book['cover_color']);
                            ?>
                            <div
                                class="spine-book <?= $tone ?>"
                    ...
                    <div class="shelf-row shelf-row--decor">
                        ...
                        <?php foreach ($books as $index => $book): ?>
                            ...
                            ?>
                            <div
                                class="spine-book <?= $tallClass ?> <?= $tone ?>"
                                style="background: linear-gradient(180deg, <?= $coverColor ?> 0%, #241109 100%);"
                            >
                                <span><?= $title ?></span>
                            </div>
